...
//	辅助函数模板:
	BinAVLTreeNode<ElemType> *CopyTreeHelp(BinAVLTreeNode<ElemType> *r);	// 复制二叉平衡树
...
template <class ElemType, class KeyType>
BinAVLTreeNode<ElemType> *BinaryAVLTree<ElemType, KeyType>::CopyTreeHelp(BinAVLTreeNode<ElemType> *r)
