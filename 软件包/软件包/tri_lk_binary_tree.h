...
//	辅助函数模板:
	TriLkBinTreeNode<ElemType> *CopyTreeHelp(TriLkBinTreeNode<ElemType> *r);// 复制二叉树
...
template <class ElemType>
TriLkBinTreeNode<ElemType> *TriLkBinaryTree<ElemType>::CopyTreeHelp(TriLkBinTreeNode<ElemType> *r)
